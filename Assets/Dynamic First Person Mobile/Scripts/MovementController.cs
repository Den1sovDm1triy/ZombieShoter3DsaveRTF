...
namespace FirstPersonMobileTools.DynamicFirstPerson
{
    ...
    #region Editor accessible field
        ...
        [SerializeField]private CameraLook m_CameraLook;  // Available joystick mobile in the scene
        ...
        {    
            ...
            get{
                ...
                return m_WalkSpeed+PlayerUpgradeManager.Instance.speedX;
                else return m_WalkSpeed;
                //return m_WalkSpeed;
        ...
        private void Stopper(bool isStop)
        {
           // isActive = !isStop;
        }
